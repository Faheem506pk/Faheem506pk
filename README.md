...
- Developed dynamic web applications using **ReactJS**, enhancing functionality and user interactivity
- Worked on state management, UI/UX improvements, and version control (**Git**, **GitHub**)
- Built a **Notion-style table clone** and contributed to **X.zaplead.ai**
- Integrated and worked with the **Big-AGI library** for AI-driven functionalities
...
### **Social Media Manager** at BestMobile.pk (01/2020 – 06/2024)

- Managed the company's social media accounts, overseeing content creation, post scheduling, and engagement strategies
- Created engaging content and animations using **Adobe Photoshop** and **After Effects**
...
I'm currently expanding my skill set as a Full Stack Developer by:

- Mastering **Next.js** for server-side rendering and optimized React applications
- Learning the complete **MERN Stack** (MongoDB, Express, React, Node.js)
- Exploring **Python** for backend development and data processing
- Enhancing my knowledge of modern UI/UX design principles
- Deepening my understanding of cloud services and deployment strategies
